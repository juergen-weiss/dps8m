...
#define CLR_I_ABS   CLRF (cpu_p->cu.IR, I_ABS)
#define CLR_I_MIF   CLRF (cpu_p->cu.IR, I_MIF)
#define CLR_I_TRUNC CLRF (cpu_p->cu.IR, I_TRUNC)
#define CLR_I_NBAR  CLRF (cpu_p->cu.IR, I_NBAR)
#define CLR_I_TALLY CLRF (cpu_p->cu.IR, I_TALLY)
#define CLR_I_PMASK CLRF (cpu_p->cu.IR, I_PMASK)
#define CLR_I_EOFL  CLRF (cpu_p->cu.IR, I_EOFL)
#define CLR_I_EUFL  CLRF (cpu_p->cu.IR, I_EUFL)
#define CLR_I_OFLOW CLRF (cpu_p->cu.IR, I_OFLOW)
#define CLR_I_CARRY CLRF (cpu_p->cu.IR, I_CARRY)
#define CLR_I_NEG   CLRF (cpu_p->cu.IR, I_NEG)
#define CLR_I_ZERO  CLRF (cpu_p->cu.IR, I_ZERO)

#define SET_I_ABS   SETF (cpu_p->cu.IR, I_ABS)
#define SET_I_NBAR  SETF (cpu_p->cu.IR, I_NBAR)
#define SET_I_TRUNC SETF (cpu_p->cu.IR, I_TRUNC)
#define SET_I_TALLY SETF (cpu_p->cu.IR, I_TALLY)
#define SET_I_EOFL  SETF (cpu_p->cu.IR, I_EOFL)
#define SET_I_EUFL  SETF (cpu_p->cu.IR, I_EUFL)
#define SET_I_OFLOW SETF (cpu_p->cu.IR, I_OFLOW)
#define SET_I_CARRY SETF (cpu_p->cu.IR, I_CARRY)
#define SET_I_NEG   SETF (cpu_p->cu.IR, I_NEG)
#define SET_I_ZERO  SETF (cpu_p->cu.IR, I_ZERO)

#define TST_I_ABS   TSTF (cpu_p->cu.IR, I_ABS)
#define TST_I_MIF   TSTF (cpu_p->cu.IR, I_MIF)
#define TST_I_NBAR  TSTF (cpu_p->cu.IR, I_NBAR)
#define TST_I_PMASK TSTF (cpu_p->cu.IR, I_PMASK)
#define TST_I_TRUNC TSTF (cpu_p->cu.IR, I_TRUNC)
#define TST_I_TALLY TSTF (cpu_p->cu.IR, I_TALLY)
#define TST_I_OMASK TSTF (cpu_p->cu.IR, I_OMASK)
#define TST_I_EUFL  TSTF (cpu_p->cu.IR, I_EUFL )
#define TST_I_EOFL  TSTF (cpu_p->cu.IR, I_EOFL )
#define TST_I_OFLOW TSTF (cpu_p->cu.IR, I_OFLOW)
#define TST_I_CARRY TSTF (cpu_p->cu.IR, I_CARRY)
#define TST_I_NEG   TSTF (cpu_p->cu.IR, I_NEG)
#define TST_I_ZERO  TSTF (cpu_p->cu.IR, I_ZERO)
#define TST_I_HEX   TSTF (cpu_p->cu.IR, I_HEX)

#ifdef DPS8M
#define SC_I_HEX(v)   SCF (v, cpu_p->cu.IR, I_HEX)
#endif
#define SC_I_MIF(v)   SCF (v, cpu_p->cu.IR, I_MIF)
#define SC_I_TALLY(v) SCF (v, cpu_p->cu.IR, I_TALLY)
#define SC_I_NEG(v)   SCF (v, cpu_p->cu.IR, I_NEG)
#define SC_I_ZERO(v)  SCF (v, cpu_p->cu.IR, I_ZERO)
#define SC_I_CARRY(v) SCF (v, cpu_p->cu.IR, I_CARRY);
#define SC_I_OFLOW(v) SCF (v, cpu_p->cu.IR, I_OFLOW);
#define SC_I_EOFL(v)  SCF (v, cpu_p->cu.IR, I_EOFL);
#define SC_I_EUFL(v)  SCF (v, cpu_p->cu.IR, I_EUFL);
#define SC_I_OMASK(v) SCF (v, cpu_p->cu.IR, I_OMASK);
#define SC_I_PERR(v)  SCF (v, cpu_p->cu.IR, I_PERR);
#define SC_I_PMASK(v) SCF (v, cpu_p->cu.IR, I_PMASK);
#define SC_I_TRUNC(v) SCF (v, cpu_p->cu.IR, I_TRUNC);
